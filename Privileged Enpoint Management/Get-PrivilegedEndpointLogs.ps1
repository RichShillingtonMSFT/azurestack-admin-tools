...
.EXAMPLE
    .\Get-PrivilegedEndpointLogs.ps1 -LogFilePath '\\Server1\Logs'
#>
[CmdletBinding()]
Param
(
...
Invoke-Command -Session $Session {Close-PrivilegedEndpoint -TranscriptsPathDestination $Using:LogFilePath -Credential $Using:ShareCredentials}
