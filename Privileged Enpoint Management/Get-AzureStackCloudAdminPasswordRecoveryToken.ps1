<#
.SYNOPSIS
    Script to get Azure Stack Cloud Admin Recovery Token

.DESCRIPTION
    Use this to get the Azure Stack Cloud Admin Recovery Token from Privileged Endpoint without entering the CloudAdmin User Password.
...
.EXAMPLE
    .\Get-AzureStackCloudAdminPasswordRecoveryToken.ps1
#>
[CmdletBinding()]
Param
(
...
$RecoveryToken = Invoke-Command $Session {Get-CloudAdminPasswordRecoveryToken}

Write-Output $RecoveryToken