...
.DESCRIPTION
    Use this to get Azure Stack Update Progess and display it in a readable windowon from Privileged Endpoint without entering the CloudAdmin User Password.
